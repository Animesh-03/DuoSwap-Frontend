    ...
    return (
        <div className={clsx([css.root, "flex flex-col items-start justify-between"])}>
            ...
            <div className="flex items-center justify-between w-full">
                <input disabled={disabled}  className="text-3xl w-60 border-none outline-none" defaultValue={0} value={amount ? amount*0.999 : undefined} onChange={(e) => setAmount && setAmount(Number(e.currentTarget.value))} />
